        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="menu-logo">
                        <a href="index.php"><img  src="../assets/image/menu-logo.png"></a>
                    </div>
                </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
                            <ul class="navbar-nav w-100 d-flex justify-content-between align-items-center">
                                <li>
                                    <div class="dropdown">
                                        <button class="btns" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            Invest <img  src="../assets/image/menu-icon.png">
                                        </button>
                                                        ...
                                                        <div class="product">
                                                            ...
                                                            <a href="how-it-works.php">
                                                                <div class="drop-page">
                                                                    ...
                                                                    <div>
                                                                        <h4>How it Works</h4>
                                                                        <p>Simplify Investing & Liquidating 
                                                                        Exotic Assets through Jericho</p>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="platform-features.php">
                                                                <div class="drop-page">
                                                                    ...
                                                                    <div>
                                                                        <h4>Platfrom features and benefits</h4>
                                                                        <p>Discover the benefits of 
                                                                        investing throught Jericho 
                                                                        Alternatives</p>
                                                                    </div>
                                                                </div>
                                                            </a>
                                ...
                                <li>
                                    <div class="dropdown">
                                        <button class="btns" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            Resources <img  src="../assets/image/menu-icon.png">
                                        </button>
                                        <ul class="dropdown-menu">
                                            <div class="container">
                                                <div class="row">
                                                        ...
                                                        <div class="product">
                                                            ...
                                                            <a href="insights.php">
                                                                <div class="drop-page">
                                                                    ...
                                                                    <div>
                                                                        <h4>Our Insights</h4>
                                                                        <p>Find Research and News curated by our Alternatives
                                                                            Assets Specialist Team 
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="faq.php">
                                                                <div class="drop-page">
                                                                    ...
                                                                    <div>
                                                                        <h4>FAQs</h4>
                                                                        <p>Common Questions you may encounter</p>
                                                                    </div>
                                                                </div>
                                                            </a>
